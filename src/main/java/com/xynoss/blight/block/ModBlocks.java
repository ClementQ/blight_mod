...
//Blight Ores
    public static final Block BLIGHT_ORE = registerBlock("blight_ore",new OreBlocks(
        ...
        List.of(ModTags.Items.NYXIUM_TOOLS)
));
    public static final Block DEEPSLATE_BLIGHT_ORE = registerBlock("deepslate_blight_ore",new OreBlocks(
    ...
    public static final Block NETHER_TRIONITE_ORE = registerBlock("nether_trionite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.ELDRANITE_TOOLS)
    ));
    ...
    public static final Block NETHER_PYRALITE_ORE = registerBlock("nether_pyralite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.TRIONITE_TOOLS)
    ));
    ...
    public static final Block VALTHERIUM_ORE = registerBlock("valtherium_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.PYRALITE_TOOLS)
    ));
    ...
    public static final Block OBRYTHIUM_ORE = registerBlock("obrythium_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.VALTHERIUM_TOOLS)
    ));
