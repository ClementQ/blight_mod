...
//Blight Ores
    ...
    public static final Block NETHER_ELDRANITE_ORE = registerBlock("nether_eldranite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.MYTHRION_TOOLS, ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS)
    ));
    ...
    public static final Block NETHER_TRIONITE_ORE = registerBlock("nether_trionite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS)
    ));
    ...
    public static final Block NETHER_PYRALITE_ORE = registerBlock("nether_pyralite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS)
    ));
    ...
    public static final Block VALTHERIUM_ORE = registerBlock("valtherium_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS)
    ));
