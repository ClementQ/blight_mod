...
//Blight Ores
    ...
    public static final Block NETHER_ELDRANITE_ORE = registerBlock("nether_eldranite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.MYTHRION_TOOLS, ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)
    ));
    ...
    public static final Block NETHER_TRIONITE_ORE = registerBlock("nether_trionite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)
    ));
    ...
    public static final Block NETHER_PYRALITE_ORE = registerBlock("nether_pyralite_ore",new OreBlocks(
            ...
            List.of(ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)
    ));
    ...
    //VALTHERIUM
    public static final Block VALTHERIUM_ORE = registerBlock("valtherium_ore",new OreBlocks(
            UniformIntProvider.create(1, 1),
            AbstractBlock.Settings.create().
                    strength(4f)
                    .requiresTool()
            ...
            List.of(ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)
    ));
    public static final Block VALTHERIUM_BLOCK = registerBlock("valtherium_block", new Block(AbstractBlock.Settings.create()
            .strength(4f)
            .requiresTool()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Blight.MOD_ID,"valtherium_block")))
    ));
    public static final Block RAW_VALTHERIUM_BLOCK = registerBlock("raw_valtherium_block", new Block(AbstractBlock.Settings.create()
            .strength(4f)
            .requiresTool()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Blight.MOD_ID,"raw_valtherium_block")))
    ));

    //OBRYTHIUM
    public static final Block OBRYTHIUM_ORE = registerBlock("obrythium_ore",new OreBlocks(
            UniformIntProvider.create(1, 1),
            AbstractBlock.Settings.create().
                    strength(4f)
                    .requiresTool()
            ...
            List.of(ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)
    ));
    public static final Block OBRYTHIUM_BLOCK = registerBlock("obrythium_block", new Block(AbstractBlock.Settings.create()
            .strength(4f)
            .requiresTool()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Blight.MOD_ID,"obrythium_block")))
    ));
    public static final Block RAW_OBRYTHIUM_BLOCK = registerBlock("raw_obrythium_block", new Block(AbstractBlock.Settings.create()
            .strength(4f)
            .requiresTool()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Blight.MOD_ID,"raw_obrythium_block")))
    ));
    ...
    public static final Block NYXIUM_ORE = registerBlock("nyxium_ore", new OreBlocks(UniformIntProvider.create(1, 1), AbstractBlock.Settings.create()
            ...
            List.of(ModTags.Items.OBRYTHIUM_TOOLS)
    ));
