...
//        addDrop(ModBlocks.BURNING_STONE, createRequiredToolMultipleDrops(ModBlocks.BURNING_STONE, ModItems.BURNING_STONE_ASHES, 1, 3, ModTags.Items.BLIGHT_TOOLS));
        ...
        addDrop(ModBlocks.NETHER_ELDRANITE_ORE,     createRequiredToolMultipleDrops(ModBlocks.NETHER_ELDRANITE_ORE, ModItems.RAW_ELDRANITE, 1,  1, List.of(ModTags.Items.MYTHRION_TOOLS, ModTags.Items.TRIONITE_TOOLS,ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.PYRALITE_TOOLS)));
        addDrop(ModBlocks.NETHER_TRIONITE_ORE,      createRequiredToolMultipleDrops(ModBlocks.NETHER_TRIONITE_ORE,  ModItems.RAW_TRIONITE,  1,  1, List.of(ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS)));
        addDrop(ModBlocks.NETHER_PYRALITE_ORE,      createRequiredToolMultipleDrops(ModBlocks.NETHER_PYRALITE_ORE,  ModItems.RAW_PYRALITE,  1,  1, List.of(ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS)));
