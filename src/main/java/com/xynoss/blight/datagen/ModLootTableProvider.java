...
//        addDrop(ModBlocks.BURNING_STONE, createRequiredToolMultipleDrops(ModBlocks.BURNING_STONE, ModItems.BURNING_STONE_ASHES, 1, 3, ModTags.Items.BLIGHT_TOOLS));
        ...
        addDrop(ModBlocks.NETHER_ELDRANITE_ORE,     createRequiredToolMultipleDrops(ModBlocks.NETHER_ELDRANITE_ORE, ModItems.RAW_ELDRANITE, 1,  1, List.of(ModTags.Items.MYTHRION_TOOLS, ModTags.Items.TRIONITE_TOOLS,ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)));
        addDrop(ModBlocks.NETHER_TRIONITE_ORE,      createRequiredToolMultipleDrops(ModBlocks.NETHER_TRIONITE_ORE,  ModItems.RAW_TRIONITE,  1,  1, List.of(ModTags.Items.ELDRANITE_TOOLS, ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)));
        addDrop(ModBlocks.NETHER_PYRALITE_ORE,      createRequiredToolMultipleDrops(ModBlocks.NETHER_PYRALITE_ORE,  ModItems.RAW_PYRALITE,  1,  1, List.of(ModTags.Items.TRIONITE_TOOLS, ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)));
        addDrop(ModBlocks.VALTHERIUM_ORE,           createRequiredToolMultipleDrops(ModBlocks.VALTHERIUM_ORE,       ModItems.RAW_VALTHERIUM,1,  1, List.of(ModTags.Items.PYRALITE_TOOLS, ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)));
        addDrop(ModBlocks.OBRYTHIUM_ORE,            createRequiredToolMultipleDrops(ModBlocks.OBRYTHIUM_ORE,        ModItems.RAW_OBRYTHIUM, 1,  1, List.of(ModTags.Items.VALTHERIUM_TOOLS, ModTags.Items.OBRYTHIUM_TOOLS)));
        addDrop(ModBlocks.NYXIUM_ORE,               createRequiredToolMultipleDrops(ModBlocks.NYXIUM_ORE,           ModItems.RAW_NYXIUM,    1,  1, List.of(ModTags.Items.MYTHRION_TOOLS)));
