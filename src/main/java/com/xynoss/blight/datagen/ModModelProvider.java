...
//Blight Items
        ...
        itemModelGenerator.register(ModItems.ELDRANITE_SWORD, Models.HANDHELD);
        itemModelGenerator.register(ModItems.ELDRANITE_PICKAXE, Models.HANDHELD);
        itemModelGenerator.register(ModItems.ELDRANITE_SHOVEL, Models.HANDHELD);
        ...
        itemModelGenerator.register(ModItems.VALTHERIUM_SWORD, Models.HANDHELD);
        itemModelGenerator.register(ModItems.VALTHERIUM_PICKAXE, Models.HANDHELD);
        itemModelGenerator.register(ModItems.VALTHERIUM_SHOVEL, Models.HANDHELD);
